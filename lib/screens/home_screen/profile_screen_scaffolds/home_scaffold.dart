...
class HomeProgressReportWidget extends StatefulWidget {
  final proposals;
  final interviews;
  final rating;

  HomeProgressReportWidget(
      {this.interviews = 0, this.proposals = 0, this.rating = 0});

  @override
  _HomeProgressReportWidgetState createState() =>
      _HomeProgressReportWidgetState();
}

class _HomeProgressReportWidgetState extends State<HomeProgressReportWidget> {
  @override
  Widget build(BuildContext context) {
    return Padding(
      padding: EdgeInsets.only(top: 20, left: 20, right: 20),
